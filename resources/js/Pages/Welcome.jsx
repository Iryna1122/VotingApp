            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    <div className="flex justify-center">
                        ...
                        {/*    />*/}
                        {/*</svg>*/}
                        <img src="https://rpr.org.ua/wp-content/themes/rpr2018/img/logo.svg" alt="photo"/>
                            ...
                            <a
                                ...
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        ...
                                        кримінального правопорушення проти виборчих прав громадян;
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        ...
                                        кандидатів у депутати сільської, селищної, міської ради (де кількість виборців до 10 тис.);
                                        кандидатів на посаду сільського, селищного, міського голову (незалежно від кількості виборців).
                                        Висування партією можливе для:

                                        кандидатів у депутати сільської, селищної, міської ради (де кількість виборців від 10 тис.);
                                        кандидатів на посаду сільського, селищного, міського голову (незалежно від кількості виборців).
